...
const RAW_TOOLS: [string, string, ToolCategory, string, string, boolean, string[]][] = [
  ...
  ['gradient', 'Gradient Tool', 'design', 'linear-gradient()', 'Build linear, radial and conic CSS gradients by dragging stops on the canvas, or paste any CSS gradient to edit it. Alpha, OKLab blending, PNG and SVG export.', true, ['css gradient generator', 'gradient generator', 'linear gradient', 'radial gradient', 'conic gradient', 'css to gradient', 'gradient background', 'tailwind gradient']],
  ['color', 'Color Tool', 'design', 'oklch()', 'Convert a color across ten models and generate ramps, harmonies, WCAG and APCA contrast, vision simulation and a UI palette.', true, ['color picker', 'palette generator', 'hex to rgb', 'oklch', 'contrast checker', 'color blindness']],
  ...
  ['wc-cart-fee', 'Cart Fee & Discount', 'woocommerce', 'WC_Cart::add_fee()', 'Conditional cart fees and negative-fee discounts on woocommerce_cart_calculate_fees, with a live cart totals preview.', true, ['surcharge', 'discount', 'cart total', 'fee']],
